...
import Textlogy from "./components/Textlogy";
...
function App() {
  ...
  return (
    ...
    <BrowserRouter>
       <Routes>
        <Route path="/" element={<><Navbar title="TextLogy" mode={mode} toggleMode={toggleMode} textcolorSwitch={textcolorSwitch} switchColor={switchColor}/>
        <Alert alert= {alert}/>
        <div className="container my-3"><TextForm heading="Enter you text to analyze" showAlert={showAlert} mode={mode}/></div></>} />

        <Route path="/about" element={<><Navbar title="TextLogy" mode={mode} toggleMode={toggleMode} textcolorSwitch={textcolorSwitch} switchColor={switchColor}/>
        <Alert alert= {alert}/><div className="container my-3"><About mode={mode}/> </div></>} />

        <Route path="/textlogy" element={<><Navbar title="TextLogy" mode={mode} toggleMode={toggleMode} textcolorSwitch={textcolorSwitch} switchColor={switchColor}/>
        <Alert alert= {alert}/><div className="container my-3"><Textlogy mode={mode}/> </div></>} />  
