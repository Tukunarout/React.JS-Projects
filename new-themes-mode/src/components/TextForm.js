...
export default function TextForm(props) {
  ...
  return (
    <>
    <div className="container" style={{color: props.mode === 'dark' || props.mode === 'primary' || props.mode === 'success' || props.mode === 'warning' ? 'white' : 'black'
}}>
        <h1>{props.heading}</h1>
        <div className="mb-3">
            <textarea className="form-control" placeholder="Enter your text...." style={{backgroundColor: props.mode === 'dark' 
                ...
                : props.mode === 'warning' 
                ? '#ad840b' 
                : 'rgb(232 226 226)',color: props.mode === 'dark' || props.mode === 'primary' || props.mode === 'success' ? 'white' : 'black'}} value={text} onChange={handleOnChange} id="myBox" rows="8"></textarea>
        </div>
